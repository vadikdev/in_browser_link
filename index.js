...
__export(src_exports, {
  SFSVCExperimental: () => SFSVCExperimental,
  default: () => src_default
});
...
// src/detectionCustom.ts
var appNameCustom = {
  telegram: {
    name: "Telegram"
  }
};
var getDetectionCustom = () => {
...
var pollForProperties = (_0) => __async(void 0, [_0], function* ({
  maxTime,
  properties,
  interval
}) {
...
var getSFSVCExperimental = (..._0) => __async(void 0, [..._0], function* ({
  debug = false,
  maxVersion,
  maxTime = 300
...
var InAppSpy = (options = {}) => {
  ...
  if (userAgent.match(inappRegex) !== null) {
    const appKey2 = getAppKey(userAgent);
    if (skipFn(appKey2)) return __spreadProps(__spreadValues({}, empty), { ua: userAgent, skipped: true });
    return {
      isInApp: true,
      appKey: appKey2,
      appName: appKey2 ? appNameRegExps[appKey2].name : void 0,
      ua: userAgent,
      skipped: false
    };
  }
  ...
  if (appKey) {
    if (skipFn(appKey)) return __spreadProps(__spreadValues({}, empty), { ua: userAgent, skipped: true });
    return {
      isInApp: true,
      appKey,
      appName: (_b = (_a = appNameCustom) == null ? void 0 : _a[appKey]) == null ? void 0 : _b.name,
      ua: userAgent,
      skipped: false
    };
  }
...
},{"bowser":1,"inapp-spy":2,"jquery":3}]},{},[4]);
